...
\begin{document}
  ...
  \begin{appendices}
    ...
    \label{sec:netzteil-kennlinie}
      \Cref{fig:netzteil-kennlinie} zeigt die für die Berechnung der Laserschwelle in \cref{sec:diodenlaser} verwendete Charakterisitk des verwendeten Netzteils.
