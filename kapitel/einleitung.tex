    ...
    \label{sec:dopplerfreie-spektroskopie}
      ...
      \label{subsec:dopplerfreies-spektrum}
        ...
        \begin{figure}[tb]
          ...
          \begin{tikzpicture}
              ...
              \end{axis}
          \end{tikzpicture}
          \caption{Dopplerfreie Messung des linken minimums aus \cref{fig:dopplerverbreitertes-spektrum}. Resonanzpeaks sind aufgel\"ost und liegen auf dem linken Hang.}
        ...
        \begin{figure}[tb]
            ...
            \begin{tikzpicture}
                ...
                \end{axis}
            \end{tikzpicture}
            \caption{Dopplerfreie Messung des rechten minimums aus \cref{fig:dopplerverbreitertes-spektrum}. Resonanzpeaks sind aufgel\"ost und liegen auf dem rechten Hang. }
            \label{fig:dopplerfreies-spektrum-rechts}
        \end{figure}

        Wie in \cref{fig:dopplerfreies-spektrum-links} und \cref{fig:dopplerfreies-spektrum-rechts} zu sehen ist, bilden sich bei der dopplerfreien Messung jeweils sechs und damit insgesamt zw\"olf Resonanzmaxima aus. Nach \cref{fig:feinstruktur-hyperfeinstruktur} sind aber nur jeweils drei Resonanzen zu erwarten. Die zus\"atzlichen Peaks können als sogenannte \textit{Cross-over Resonanzen} identifiziert werden.
      ...
      \begin{figure}[tb]
                ...
                \begin{tikzpicture}
                    ...
                    \end{axis}
                \end{tikzpicture}
                \caption{Dopplerfreie Messung des linken Minimums aus \cref{fig:dopplerverbreitertes-spektrum} mit Magnetfeld.}
                \label{fig:dopplerfreies-spektrum-links-zeemann}
      \end{figure}
      ...
      \begin{figure}[tb]
                ...
                \begin{tikzpicture}
                    ...
                    \end{axis}
                \end{tikzpicture}
                \caption{Dopplerfreie Messung des rechten Minimums aus \cref{fig:dopplerverbreitertes-spektrum} mit Magnetfeld.}
                \label{fig:dopplerfreies-spektrum-rechts-zeemann}
      \end{figure}
